...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $stains = new Stains();
        $stains->setTask('faire la vaisselle')
            ->setProject('Administration')
            ->setState('Cloturée')
            ->setCreatedAt(new \DateTime());
        $manager->persist($stains);

        $stains = new Stains();
        $stains->setTask('faire la table')
            ->setProject('Administration')
            ->setState('Cloturée')
            ->setCreatedAt(new \DateTime());
        $manager->persist($stains);
        ...
        $stains = new Stains();
        $stains->setTask('faire la voiture')
            ->setProject('Administration')
            ->setState('Cloturée')
            ->setCreatedAt(new \DateTime());
        $manager->persist($stains);
        ...
        $stains = new Stains();
        $stains->setTask('tourner la page')
            ->setProject('Administration')
            ->setState('Cloturée')
            ->setCreatedAt(new \DateTime());
        $manager->persist($stains);
